    ...
    <div class="overflow-x-auto">
      <table class="w-full">
        <thead class="bg-white/50 dark:bg-slate-800/50 backdrop-blur-sm">
          <tr>
            <th class="px-6 py-5 text-xs font-bold text-slate-500 uppercase tracking-wider text-center">#</th>
            <th class="px-6 py-5 text-xs font-bold text-slate-500 uppercase tracking-wider">Membre</th>
            <th class="px-6 py-5 text-xs font-bold text-slate-500 uppercase tracking-wider text-right">Stats</th>
            <th class="px-6 py-5 text-sm font-bold text-purple-600 uppercase tracking-widest text-right">Score {{
              statLabel }}</th>
          </tr>
        </thead>

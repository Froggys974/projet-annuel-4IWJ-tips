...
const { data: tips } = await useFetch<Tip[]>('/api/tips')
  ...
  <div class="space-y-12 pb-12">
    ...
    <section class="relative rounded-3xl pt-20 pb-16 md:pt-32 md:pb-24 overflow-hidden">
      ...
      <div class="max-w-5xl mx-auto px-6 text-center">
        ...
        <h1 class="text-4xl md:text-6xl font-black text-slate-800 dark:text-white leading-tight mb-6">
          L’entraide sur
          <span class="text-transparent bg-clip-text bg-linear-to-r from-purple-600 to-pink-600">tous types de
            sujets</span>
        </h1>

        <p class="text-lg md:text-xl text-slate-500 dark:text-slate-400 max-w-2xl mx-auto mb-8 leading-relaxed">
          Bricolage, Cuisine, Informatique, Jardinage... Peu importe votre besoin, trouvez la solution ou aidez
        ...
        <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
          <AppButton to="/tips/create" variant="primary" size="lg"

      ...
      <main class="lg:col-span-9">
        <div
          ...
          <div v-if="activeTab === 'general'" class="space-y-8 animate-fade-in">
            ...
            <div
              ...
              <div class="relative group">
                <ProfilPicture :src="user?.avatar || 'https://i.pravatar.cc/150?u=1'" size="xl"
              ...
              <div>
                ...
                <p class="text-sm text-slate-500 mb-3">Affichée sur votre profil et vos commentaires.</p>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              <AppInput id="name" label="Nom d'affichage" placeholder="Votre nom" v-model="form.name" />
              <AppInput id="email" label="Email" type="email" placeholder="votre@email.com" v-model="form.email" />
              <div class="md:col-span-2">
                <AppTextarea id="bio" v-model="form.bio" label="Biographie" placeholder="Parlez-nous de vous..."
                  :rows="4" />
              </div>
              <div class="md:col-span-2">
                <AppInput id="address" v-model="form.address" label="Localisation" placeholder="Paris, France"
                  icon="tabler:map-pin" />
              </div>
            </div>
          ...
          <div v-if="activeTab === 'security'" class="space-y-8 animate-fade-in">
            ...
            <div class="space-y-6">
              <div class="p-6 bg-white/50 dark:bg-slate-800/50 rounded-3xl border border-white/20">
                <h3 class="font-bold text-lg mb-4 text-slate-900 dark:text-white">Changer de mot de passe</h3>
                <div class="grid gap-4 max-w-md">
                  <AppInput id="currentPassword" label="Mot de passe actuel" type="password"
                    v-model="form.currentPassword" />
                  <AppInput id="newPassword" label="Nouveau mot de passe" type="password" v-model="form.newPassword" />
                  <AppInput id="confirmPassword" label="Confirmer le mot de passe" type="password"
              ...
              <div
                ...
                <div>
                  <div class="font-bold text-lg text-slate-900 dark:text-white flex items-center gap-2">
                    Double Authentification (2FA)
                    <span
                      class="px-2 py-0.5 rounded text-[10px] font-black bg-green-500/10 text-green-600 uppercase">Recommandé</span>
                  </div>
                  <p class="text-sm text-slate-500 mt-1">Sécurisez votre compte avec une étape supplémentaire.</p>
                </div>
          ...
          <div v-if="activeTab === 'notifications'" class="space-y-8 animate-fade-in">
            ...
            <div class="space-y-4">
              <div v-for="(val, key) in notifications" :key="key"
